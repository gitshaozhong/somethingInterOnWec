...
/* harmony export */ });
/* unused harmony exports STUDENT_SELF_LEVELS, TIME_SLOTS, formatHourRange, REVIEW_TAGS_COACH, REVIEW_TAGS_STUDENT, BEIJING_VENUES, DISTANCE_OPTIONS, groupVenuesByDistrict, BEIJING_VENUES_GROUPED, siteConfig */
...
function formatHourRange(start, end) {
  ...
  var s = String(start).padStart(2, "0");
  if (end == null || end <= start) return "".concat(s, ":00");
  return "".concat(s, ":00-").concat(String(end).padStart(2, "0"), ":00");
}
...
var BEIJING_VENUES = [{
  name: "朝阳体育中心羽毛球馆",
  address: "北京市朝阳区姚家园路朝阳体育中心",
  district: "朝阳"
}, {
  name: "奥体中心羽毛球馆",
  address: "北京市朝阳区安定路奥体中心",
  district: "朝阳"
}, {
  name: "地坛体育馆羽毛球馆",
  address: "北京市东城区安定门外大街地坛体育馆",
  district: "东城"
}, {
  name: "首体羽毛球馆",
  address: "北京市海淀区中关村南大街首都体育馆",
  district: "海淀"
}, {
  name: "五棵松文化体育中心羽毛球馆",
  address: "北京市海淀区复兴路五棵松",
  district: "海淀"
}, {
  name: "清华大学综合体育馆羽毛球馆",
  address: "北京市海淀区清华大学",
  ...
  name: "广安体育馆羽毛球馆",
  address: "北京市西城区广安门内大街",
  district: "西城"
}, {
  name: "丰台体育中心羽毛球馆",
  address: "北京市丰台区西四环南路丰台体育中心",
  district: "丰台"
}, {
  name: "石景山体育馆羽毛球馆",
  address: "北京市石景山区八角大街石景山体育馆",
  district: "石景山"
}, {
  name: "通州区体育中心羽毛球馆",
  address: "北京市通州区新华大街通州体育中心",
  district: "通州"
}, {
  name: "顺义区体育馆羽毛球馆",
  address: "北京市顺义区光明南街顺义体育馆",
  district: "顺义"
}, {
  name: "昌平区体育馆羽毛球馆",
  address: "北京市昌平区南环路昌平体育馆",
  district: "昌平"
}, {
  name: "大兴区体育馆羽毛球馆",
  address: "北京市大兴区黄村镇大兴体育馆",
  district: "大兴"
}, {
  name: "房山区体育馆羽毛球馆",
  address: "北京市房山区良乡房山体育馆",
  district: "房山"
}, {
  name: "怀柔区体育馆羽毛球馆",
  address: "北京市怀柔区青春路怀柔体育馆",
  district: "怀柔"
}, {
  name: "密云区体育馆羽毛球馆",
  address: "北京市密云区鼓楼东大街密云体育馆",
  district: "密云"
}];

/** 距离搜索选项（公里） */
var DISTANCE_OPTIONS = [3, 5, 10];

/** 价位预设（陪练档期发布） */
var PRICE_PRESETS = [{
  min: 30,
  max: 50,
  label: "30-50 元/小时（3 级陪练）"
}, {
  min: 40,
  max: 60,
  label: "40-60 元/小时（4 级陪练）"
}, {
  min: 50,
  max: 70,
  label: "50-70 元/小时（5 级陪练）"
}, {
  min: 70,
  max: 100,
  label: "70-100 元/小时（6 级以上陪练）"
}];
 ...
 */
function groupVenuesByDistrict(venues) {
  var map = {};
  var _iterator = (0,E_000Project_trae_project_2026_20260713_badminton_wechatMiniApp_miniapp_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper_js__WEBPACK_IMPORTED_MODULE_0__["default"])(venues),
    _step;
  try {
...
/** 扁平化预置球馆列表（供快捷搜索入口使用） */
var PRESET_VENUE_LIST = BEIJING_VENUES;

/** 按区域分组的预置球馆（miniapp venue-picker 使用） */
var BEIJING_VENUES_GROUPED = groupVenuesByDistrict(BEIJING_VENUES);
var siteConfig = {
